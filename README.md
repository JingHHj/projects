...
## 4. Robot Manipulation: Designed software that can manipulate a 5R robot arm on top of a chassis with Mecanum wheels.
...
## 6. Infinite-Horizon Stochastic Optimal Control Problem:
